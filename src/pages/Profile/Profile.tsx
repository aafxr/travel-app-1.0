        ...
        <div className='wrapper'>
            <div className='content hide-scroll'>
                ...
                <div className='profile-backside column gap-1 pt-20'>
                    <div className='title title-bold center'>{lang.profile}</div>
                ...
                <Curtain minOffset={54} maxOpenPercent={.5} defaultOffsetPercents={.5}>
                    <Container className='column pt-20'>
                        <LinkComponent title={lang.settings} to='/profile/settings/user/' arrow/>
                        <LinkComponent title={lang.actions} to='/profile/actions/' arrow/>
                        <LinkComponent title={lang.activeSessions} to='/profile/sessions/' arrow/>
                        <LinkComponent title={lang.errorLog} to='/profile/errors/' arrow/>
                    </Container>
                </Curtain>
            </div>
